...
final class KubernetesConfigMapLabelSupplier extends AbstractKubernetesConfigLabelSupplier {
    ...
    KubernetesConfigMapLabelSupplier(CoreV1ApiReactor coreV1ApiReactor, KubernetesConfiguration configuration) {
        super(coreV1ApiReactor, configuration, configuration.getConfigMaps());
    }
}
