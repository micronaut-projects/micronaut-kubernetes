...
class SecretOperator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(SecretOperator)
    ...
    SecretOperator(SharedIndexInformerFactory sharedIndexInformerFactory, ControllerFactory controllerFactory, NamespaceResolver namespaceResolver) {
        ...
        sharedIndexInformerFactory.sharedIndexInformerFor(V1Secret, namespace)
        controllerFactory.createController(V1Secret, Collections.singleton(namespace), new SecretReconciler())
    }
