...
class CoreV1ApiRxClientSpec extends K3sContainerSpec {

    private static final Logger LOG = LoggerFactory.getLogger(CoreV1ApiRxClientSpec.class)

    private static final NAMESPACE_NAME = "micronaut-rx3-client"
    ...
    def setupKubernetes(ApplicationContext context) {
        def reactiveClient = context.getBean(CoreV1ApiRxClient.class)
