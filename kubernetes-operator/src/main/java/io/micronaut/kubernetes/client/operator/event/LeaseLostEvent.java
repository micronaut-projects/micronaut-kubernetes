 ...
 * has lost the leader lease.
 *
 * @author Pavol Gressa
 * @since 3.3
 */
public class LeaseLostEvent extends AbstracLeaderElectingControllerEvent {

    public LeaseLostEvent(ControllerConfiguration controllerConfiguration, ControllerManager source) {
