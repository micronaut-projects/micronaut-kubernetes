...
import io.micronaut.kubernetes.client.openapi.informer.example1.CustomObject
import io.micronaut.kubernetes.client.openapi.informer.example1.CustomObjectApiReactor
import io.micronaut.kubernetes.client.openapi.informer.example1.CustomObjectList
...
class CustomObjectInformer1Spec extends K3sContainerSpec {

    private static final Logger LOG = LoggerFactory.getLogger(CustomObjectInformer1Spec.class)
    ...
    def 'test custom object informer'() {
        ...
        ApplicationContext context = ApplicationContext.run([
                ...
                'spec.name'                         : 'CustomObjectInformer1Spec'
        ])
        ...
        CustomObjectList customObjectList = listCustomObject(customObjectApiReactor, NAMESPACE_NAME_1)
    ...
    private static CustomObjectList listCustomObject(CustomObjectApiReactor customObjectApiReactor, String namespace) {
