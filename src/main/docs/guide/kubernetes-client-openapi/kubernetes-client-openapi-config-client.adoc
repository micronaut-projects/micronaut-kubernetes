...
In case if you want to terminate the service startup when the service is not able to read config maps because of any
unexpected exception, you can enable `terminate-startup-on-exception` property:
...
Similarly to ``ConfigMap``s, in case if you want to terminate the service startup when the service is not able to read secrets
because of any unexpected exception, you can enable `terminate-startup-on-exception` property:
