[IMPORTANT]
====
The Kubernetes configuration client support is deprecated and has been replaced by xref:../config-import.adoc[Configuration Import].
...
The deprecated configuration client documentation remains available for existing applications, but both the
documentation and implementation will be removed in a future release, and new applications should use configuration
import.
