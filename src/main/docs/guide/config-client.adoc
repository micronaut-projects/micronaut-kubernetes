...
The configuration client will read all the ConfigMaps for the specified namespace (or `default` if not specified).
...
The configuration client will read all the Secrets for the specified namespace (or `default` if not specified).