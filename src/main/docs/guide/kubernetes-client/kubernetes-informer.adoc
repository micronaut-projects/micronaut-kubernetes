...
snippet::io.micronaut.docs.informer.ConfigMapInformer[tags="handler"]
...
snippet::io.micronaut.docs.informer.SharedIndexInformerFactoryExample[tags="create"]
...
snippet::io.micronaut.docs.informer.SharedIndexInformerFactoryExample[tags="get"]
...
snippet::io.micronaut.docs.informer.SharedInformerCache[tags="cache"]
