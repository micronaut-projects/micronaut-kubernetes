...
[NOTE]
====
The `includes`, `excludes`, `labels`, `pod-labels`, `exception-on-pod-labels-missing`, `paths`, and `use-api` settings documented below apply to the deprecated bootstrap configuration-client mode. They are not part of the new `kubernetes-configmap:` import URI contract.
====
